...
namespace Badge.Pages.Administration.TicketAdmin
{
    public class IndexModel : PageModel
    {
        ...
        public async Task OnGetAsync(string sortOrder, string searchString, int? pageIndex)
        {
            ...
            {
                ticketsIQ = ticketsIQ.Where(t => t.Id.Contains(searchString) || t.TicketGroupAssign.Group.Name.Contains(searchString) || (t.TicketMemberAssign.Member.FName + " " + t.TicketMemberAssign.Member.LName).Contains(searchString));
            }
